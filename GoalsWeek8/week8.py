...
class Robot():
    ...
    def __init__(self):
        ...
        self.io.set_mode(self.left_triggerpin, pigpio.OUTPUT)
        self.io.set_mode(self.left_echopin, pigpio.INPUT)
        self.io.set_mode(self.center_triggerpin, pigpio.OUTPUT)
        self.io.set_mode(self.center_echopin, pigpio.INPUT)
        self.io.set_mode(self.right_triggerpin, pigpio.OUTPUT)
        self.io.set_mode(self.right_echopin, pigpio.INPUT)
